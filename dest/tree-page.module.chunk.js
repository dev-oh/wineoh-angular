webpackJsonp(["tree-page.module"],{

/***/ "../../../../../src/app/pages/tree-page/tree-dialog/tree-dialog.component.html":
/***/ (function(module, exports) {

module.exports = "<h4 mat-dialog-title>Possible actions</h4>\r\n<div mat-dialog-content>{{data.text}}</div>\r\n<div mat-dialog-actions align=\"end\">\r\n  <button mat-button (click)=\"dialogRef.close('First option')\">OK</button>\r\n</div>\r\n\r\n\r\n"

/***/ }),

/***/ "../../../../../src/app/pages/tree-page/tree-dialog/tree-dialog.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TreeDialogComponent; });
...
var TreeDialogComponent = (function () {
    function TreeDialogComponent(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
    TreeDialogComponent.prototype.ngOnInit = function () {
    };
    TreeDialogComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-tree-dialog',
            template: __webpack_require__("../../../../../src/app/pages/tree-page/tree-dialog/tree-dialog.component.html")
        }),
    ...
    return TreeDialogComponent;
    var _a;
}());

//# sourceMappingURL=tree-dialog.component.js.map

/***/ }),

/***/ "../../../../../src/app/pages/tree-page/tree-page.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/app/pages/tree-page/tree-page.component.scss":
...
// module
exports.push([module.i, ":host .wrap {\n  height: 400px;\n  max-width: 300px;\n  min-width: 250px;\n  position: relative; }\n\n:host /deep/ .toggle-children-wrapper {\n  line-height: 37px; }\n\n:host button[mat-raised-button] {\n  margin-right: 5px;\n  margin-bottom: 10px; }\n", ""]);
...
/***/ "../../../../../src/app/pages/tree-page/tree-page.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TreePageComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tree_dialog_tree_dialog_component__ = __webpack_require__("../../../../../src/app/pages/tree-page/tree-dialog/tree-dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_page_animation__ = __webpack_require__("../../../../../src/app/utils/page.animation.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TreePageComponent = (function () {
    function TreePageComponent(dialog) {
        var _this = this;
        this.dialog = dialog;
        ...
        this.actionMapping = {
            mouse: {
                contextMenu: function (tree, node, $event) {
                    ...
                    _this.dialog.open(__WEBPACK_IMPORTED_MODULE_3__tree_dialog_tree_dialog_component__["a" /* TreeDialogComponent */], { data: { text: "context menu for " + node.data.name } });
                },
                ...
                click: function (tree, node, $event) {
                    $event.shiftKey
                        ? __WEBPACK_IMPORTED_MODULE_1_angular_tree_component__["TREE_ACTIONS"].TOGGLE_SELECTED_MULTI(tree, node, $event)
                        : __WEBPACK_IMPORTED_MODULE_1_angular_tree_component__["TREE_ACTIONS"].TOGGLE_SELECTED(tree, node, $event);
                }
            },
            keys: (_a = {},
                _a[__WEBPACK_IMPORTED_MODULE_1_angular_tree_component__["KEYS"].ENTER] = function (tree, node, $event) { return _this.dialog.open(__WEBPACK_IMPORTED_MODULE_3__tree_dialog_tree_dialog_component__["a" /* TreeDialogComponent */], { data: { text: "This is " + node.data.name } }); },
                _a)
        };
        // Tree parameters
        ...
        setTimeout(function () {
            ...
            var _loop_1 = function (i) {
                _this.nodes.push({
                    ...
                    children: new Array(3).fill(null).map(function (item, n) { return ({
    ...
    TreePageComponent.prototype.getChildren = function (node) {
        var _this = this;
    ...
    TreePageComponent.prototype.filterNodes = function (text, tree) {
        tree.treeModel.filterNodes(text);
    };
    TreePageComponent.prototype.activateSubSub = function (tree) {
        tree.treeModel.getNodeById(1001).setActiveAndVisible();
    };
    TreePageComponent.prototype.go = function ($event) {
        $event.stopPropagation();
        this.dialog.open(__WEBPACK_IMPORTED_MODULE_3__tree_dialog_tree_dialog_component__["a" /* TreeDialogComponent */], { data: { text: 'this method is on the app component' } });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('@routerAnimation'),
        __metadata("design:type", Object)
    ], TreePageComponent.prototype, "routerAnimation", void 0);
    TreePageComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-tree-page',
            template: __webpack_require__("../../../../../src/app/pages/tree-page/tree-page.component.html"),
            styles: [__webpack_require__("../../../../../src/app/pages/tree-page/tree-page.component.scss")],
            animations: [__WEBPACK_IMPORTED_MODULE_4__utils_page_animation__["a" /* routerAnimation */]]
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__angular_material__["k" /* MatDialog */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_material__["k" /* MatDialog */]) === "function" && _a || Object])
    ], TreePageComponent);
    return TreePageComponent;
    var _a;
}());

//# sourceMappingURL=tree-page.component.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TreePageModule", function() { return TreePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/@angular/common.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tree_page_component__ = __webpack_require__("../../../../../src/app/pages/tree-page/tree-page.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__tree_dialog_tree_dialog_component__ = __webpack_require__("../../../../../src/app/pages/tree-page/tree-dialog/tree-dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_angular_tree_component__ = __webpack_require__("../../../../angular-tree-component/dist/angular-tree-component.umd.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_angular_tree_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_angular_tree_component__);
...
var TreePageModule = (function () {
    function TreePageModule() {
    }
    TreePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2__angular_router__["d" /* RouterModule */].forChild([
                    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__tree_page_component__["a" /* TreePageComponent */] }
                ])
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__tree_page_component__["a" /* TreePageComponent */],
                __WEBPACK_IMPORTED_MODULE_4__tree_dialog_tree_dialog_component__["a" /* TreeDialogComponent */]
            ],
            entryComponents: [
                __WEBPACK_IMPORTED_MODULE_4__tree_dialog_tree_dialog_component__["a" /* TreeDialogComponent */]
            ],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_mobx__ = __webpack_require__("../../../../mobx/lib/mobx.module.js");
...
var MobxAutorunSyncDirective = /** @class */ (function (_super) {
    ...
    MobxAutorunSyncDirective.prototype.autoDetect = function (view) {
        ...
        this.dispose = Object(__WEBPACK_IMPORTED_MODULE_1_mobx__["autorun"])(function () {
            view['detectChanges']();
        });
    };
...
var MobxAutorunDirective = /** @class */ (function () {
    ...
    MobxAutorunDirective.prototype.autoDetect = function (view) {
        ...
        this.dispose = Object(__WEBPACK_IMPORTED_MODULE_1_mobx__["autorun"])(autorunName, function () { return view['detectChanges'](); });
    };
...
//# sourceMappingURL=data:application/json;base64,
...
var MobxReactionDirective = /** @class */ (function (_super) {
    ...
    MobxReactionDirective.prototype.autoDetect = function (view) {
        this.dispose = Object(__WEBPACK_IMPORTED_MODULE_1_mobx__["reaction"])(this.mobxReaction, function () {
            view['detectChanges']();
...
/* harmony export (immutable) */ __webpack_exports__["action"] = action;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_mobx__ = __webpack_require__("../../../../mobx/lib/mobx.module.js");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "MobxAutorunDirective", function() { return __WEBPACK_IMPORTED_MODULE_1__directives_mobx_autorun_directive__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "MobxAutorunSyncDirective", function() { return __WEBPACK_IMPORTED_MODULE_2__directives_mobx_autorun_sync_directive__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "MobxReactionDirective", function() { return __WEBPACK_IMPORTED_MODULE_3__directives_mobx_reaction_directive__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mobx__ = __webpack_require__("../../../../mobx/lib/mobx.module.js");
...
var mobxAngularDebug = (function () {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0_mobx__["spy"])(function (change) { return isDebugOn() && consoleLogChange(change, function () { return true; }); });
        ...
        if (show && isGroupEnd) {
            ...
            switch (change.type) {
                ...
                case 'update':
                    ...
                    if (Object(__WEBPACK_IMPORTED_MODULE_0_mobx__["isObservableArray"])(change.object)) {
                    ...
                    else if (Object(__WEBPACK_IMPORTED_MODULE_0_mobx__["isObservableObject"])(change.object)) {
...
//# sourceMappingURL=data:application/json;base64,
...
//# sourceMappingURL=tree-page.module.chunk.js.map